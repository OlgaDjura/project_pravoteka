...
```
git clone https://gitflic.ru/project/best-team-for-pravoteka/front-vue.git
cd front-vue
...
cd existing_folder
git init
git remote add origin https://gitflic.ru/project/best-team-for-pravoteka/front-vue.git
git clone
